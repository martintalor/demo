...
public class Compare01 {
    ...
    public float getSimilarityRatio(String str, String target) {
        ...
        public static void main(String[] args) {
                 String str = "BF Replacement Coils for Cubis Tank & eGo AIO (5pcs)";
        /*String target = "BF Badge Replacement Coils for Cubis Tank 3pcs/pack";*/
        String target = "UD Athlon 25 Replacement Octuple Coil 2pcs";
        
         Compare01 lt = new Compare01();
